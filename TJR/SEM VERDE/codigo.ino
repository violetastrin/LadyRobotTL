...
int verdeEsqmin = 285;   //   245 no branco       315 no verde
int verdeEsqmax = 500;   
int verdeDirmin = 230;   //   185 no branco       265 no verde
int verdeDirmax = 400;   

//Valor core (esquerda): 236Valor cord (direita): 181
//Valor core (esquerda): 245Valor cord (direita): 182
//Valor core (esquerda): 248Valor cord (direita): 179
//Valor core (esquerda): 223Valor cord (direita): 199

//Valor core (esquerda): 343Valor cord (direita): 264
//Valor core (esquerda): 312Valor cord (direita): 252
//Valor core (esquerda): 373Valor cord (direita): 282
//Valor core (esquerda): 479Valor cord (direita): 302
...
void loop() {
  ...
  if (analogRead(cord) >= verdeEsqmin && analogRead(cord) <= verdeDirmax) {
    direitaverde = 1;
  } else {
    direitaverde = 0;
  }
